...
| AURA-A03 | Freemium limits occur after enough value is demonstrated. | Superseded: 1.0 has no limits or paywall (DEC-006). | None; revisit only with a future monetization decision. | closed |
...
| AURA-A07 | The four production StoreKit IDs can be registered and their commercial values approved. | Superseded: the IDs and StoreKit configuration were removed (DEC-006). | None. | closed |

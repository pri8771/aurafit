...
| AURA-R04 | Paywall precedes a credible first result. | — | — | Closed by DEC-006 (2026-08-18): 1.0 ships with no paywall. | Product owner | closed |
...
| AURA-R16 | Production StoreKit catalog differs from code or purchase/restore fails only in sandbox/TestFlight. | — | — | Closed by DEC-006 (2026-08-18): no StoreKit code or catalog ships in 1.0. | Monetization owner | closed |

...
Ask every external tester the same core questions. Free-text responses are optional.

1. Did you complete your first result? If not, where did you stop and what did you expect?
2. Did **Open Camera** or **Import from Library** make it clear how to choose a usable photo?
   What was missing?
3. Did the result, score explanation, and tips feel clear, respectful, and useful? Identify
   confusing or uncomfortable wording without sending your photo.
...
For a defect, also collect:

- app version and build;
- iPhone model and iOS version;
- exact steps, expected result, and actual result;
- reproducibility (`once`, `sometimes`, or `every time`);
- network state and permission state when relevant;
- screenshot or screen recording only with the tester’s informed choice.
